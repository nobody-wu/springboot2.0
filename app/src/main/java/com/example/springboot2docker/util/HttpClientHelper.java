 ...
 * @Author: wujiapeng
 * java 常见几种发送http请求案例
 * @Date: created in 17:18 2018/6/25
 */
public class HttpClientHelper {
     ...
     * @return
     */
    public static String HttpURLConnectionPost(String urlParam, Map<String, Object> params, String charset) {
     ...
     */
    public static String URLConnectionPost(String urlParam, Map<String, Object> params, String charset){
        StringBuffer resultBuffer = null;
        // 构建请求参数
        StringBuffer sbParams = new StringBuffer();
        if (params != null && params.size() > 0) {
